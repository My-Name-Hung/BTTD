...
router.get('/don-hang/:idDonHang', authMiddleware, requireRole('admin', 'dieu_phoi', 'ke_toan', 'tram_tron', 'lanh_dao', 'giam_doc_kinh_doanh', 'sales', 'sale', 'tai_xe', 'ky_thuat'), async (req: AuthRequest, res: Response<ApiResponse>) => {
  try {
